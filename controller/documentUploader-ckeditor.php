...
if (isset($_FILES['upload'])) {
	...
	include('http://localhost/sponline/include/controller/updateTheProductImageJson.php?id='.$_GET['id']);
	//require_once('include/controller/updateTheProductImageJson.php?id='.$_GET['id']);
}
else
{
