...
class DatabaseManager{
	...
	**/
    ...
    function beforeCreateInsertUpdateDelete($crudType){
    	// i must here to clear the responseArray['data'] created by getDataSchemaForSet()
    	$this->ResetResponseArray();
...
/*		if($isPKMissing){
	 ...
	 */
	function getDataSchemaForSet($isClearResponseArrayDataIndex = false){
		//$this->ResetResponseArray();
