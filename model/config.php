...
define("_DB_NAME", "acgni308_sponline", true);
define("_DB_USER", "acgni308_sluser", true);
define("_DB_PASS", "sponline741953", true);
...
define("BASE_ROOT", __DIR__."/../"); // only exists with PHP >= 5.3
