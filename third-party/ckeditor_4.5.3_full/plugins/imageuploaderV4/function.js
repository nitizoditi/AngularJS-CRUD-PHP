...
// Open image modal
function showImage(imgSrc,imgStyle, imgSrcInEditor) {
    var imgSrc = imgSrc;
    ...
    $("#imgActionUse").attr("onclick","useImage('" + imgSrc + "','"+imgSrcInEditor+"')");
...
function useImage(imgSrc, imgSrcInEditor) {
    ...
    var imgSrc = imgSrc;
    var ckpath = 'third-party/ckeditor_4.5.3_full/plugins/imageuploaderV4/';
    var fileUrl = ckpath + imgSrc;
    //var fileUrl = 
    fileUrl = imgSrcInEditor;
    console.log(fileUrl);
