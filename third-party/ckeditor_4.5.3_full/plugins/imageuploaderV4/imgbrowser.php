...
$productID = FormSubmit::GET("productID");
...
<body ontouchstart="">
<div id="header">
    <a class="headerA" href="http://imageuploaderforckeditor.altervista.org/" target="_blank"><b>Image Browser</b> for CKEditor</a>#<?php echo $productID?> image<br> 
