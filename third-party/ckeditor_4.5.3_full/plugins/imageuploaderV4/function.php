...
function viewProductImages($productID) {
    require(__DIR__ . '/pluginconfig.php');
    //$useruploadpath = BASE_RESOURCE . "productImage/$productID/";

    $userViewInEditorPath = "resourse/productImage/$productID/";
    $useruploadpath = "../../../../resourse/productImage/$productID/";
    //$useruploadpath = "http://localhost/flex/resourse/productImage/$productID";
    //$useruploadfolder = "http://localhost/flex/resourse/productImage/$productID/";
    $useruploadfolder .= $productID;
    //echo $useruploadpath;
    //if(file_exists($useruploadpath)){
        $filesizefinal = 0;
        $count = 0;
        ...
        ?>
            ...
            <div class="fileDiv" onclick="showImage('<?php echo $image; ?>','<?php echo $image_height; ?>', '<?php echo $userViewInEditorPath.$imgname; ?>');">
                <div class="imgDiv"><img class="fileImg lazy" data-original="<?php echo $image; ?>"></div>
                <p class="fileDescription"><?php echo $imgname; ?></p>
                <p class="fileTime"><?php echo date ("F d Y H:i", filemtime($image)); ?></p>
                <p class="fileTime"><?php echo $filesizetemp; ?> KB</p>
